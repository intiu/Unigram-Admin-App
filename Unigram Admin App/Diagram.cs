...
{
    public partial class Diagram : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        public Diagram()
        {
            InitializeComponent();
        ...
        private void diagramCommandInsertContainerBarSplitButtonItem1_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {

        }

        private void diagramCommandSnapToGridBarCheckItem1_CheckedChanged(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
